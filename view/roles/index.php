				...
				<?php
					if (!is_null($DaftarRole) && count($DaftarRole) > 0) {
						foreach($DaftarRole as $index => $item) {            
							...
							<tr>
								<td>
									<?php echo $item["Idrole"]; ?>
								</td>
								<td>
									<?php echo $item["Namarole"]; ?>
								</td>
								<td>
								...
								<td class="d-flex justify-content-end">						
									...
									<a href="/tk4/controller/role/delete.php?id=<?= $item["Idrole"]?>" class="btn btn-danger btn-sm" role="button" aria-disabled="true">Delete</a>
								</td>
							</tr>
				<?php
						}
